...
public class FXMLRegistroProyectoController implements Initializable {
    ...
    @FXML
    private DatePicker dpFechaProyecto;
    ...
    private void registrarProyectoSS() {
        try {
            ...
            String fechaProyecto = dpFechaProyecto.getValue().toString();
            ...
            // Validación de responsable seleccionado
            ...
            // Crear el objeto ProyectoSS con los datos validados
            ...
            proyectoSS.setFechaProyecto(fechaProyecto);
            proyectoSS.setObjetivoProyecto(objetivo);
            proyectoSS.setIdResponsable(idResponsable);

            // Validar y registrar el proyecto en la base de datos
