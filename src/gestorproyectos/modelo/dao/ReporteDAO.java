...
public class ReporteDAO {
    ...
    public static HashMap<String, Object> obtenerReportes(int idExpediente) throws SQLException{
    ...
    public static HashMap<String, Object> subirReporte(Reporte reporte) throws SQLException{
        ...
        try{
            ...
            if(filasAfectadas > 0){
                ...
                respuesta.put("mensaje","Lo sentimos, hubo un error al guardar el reporte, por favor revisa la informacion");
            }
            conexionBD.close();
